...
Justification: The Factory pattern enables dynamic creation of care task objects based on type (e.g., FeedingTask, VetVisitTask, VaccinationTask) without changing the client code.
